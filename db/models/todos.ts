...
export type todosCreationAttributes = Optional<todosAttributes, todosOptionalAttributes>;

export class todos extends Model<todosAttributes, todosCreationAttributes> implements todosAttributes {
  id!: number;
  name?: string;
  user_id?: number;
